    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <header className="flex justify-between items-center h-16 px-6 bg-white border-b border-border shadow-sm sticky top-0 z-40">
        <div className="flex items-center gap-4">
          <Link href="/client/dashboard" className="material-symbols-outlined text-gray-700 hover:text-primary transition-colors cursor-pointer">arrow_back</Link>
                    ...
                    {expanding ? (
                      ...
                      <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-800 space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">{expandedData.barber?.name || 'Unknown'}</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="pt-4 mt-2">
                          <Link href="/client/bookings" className="block w-full text-center py-2.5 bg-primary text-white font-semibold rounded-lg hover:opacity-90 transition-opacity active:scale-95">
                            View in Bookings
                          </Link>
                        </div>
                      </div>
